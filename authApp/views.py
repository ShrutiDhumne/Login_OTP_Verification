...
def send_otp(number,message):
    ...
    api = "FastSM"    ## API key has been expired thats way its not sending the OTP now.
    querystring = {"authorization":api,"sender_id":"FastSM","message":message,"language":"english","route":"p","numbers":number}
    headers = {
